...
import cc.uncarbon.module.app.interceptor.AppSaTokenRouteInterceptor;
import cc.uncarbon.module.sys.constant.SysConstant;
import cc.uncarbon.module.sys.interceptor.AdminSaTokenParseInterceptor;
...
public class SaTokenInterceptorConfiguration implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        2. App-路由拦截器, 使几乎所有接口都需要登录
            不过不知道为什么，似乎还得搭配AppSaTokenRouteInterceptor才行
         */
        registry
                .addInterceptor(new AppSaTokenRouteInterceptor())
                .addPathPatterns(AppConstant.APP_MODULE_CONTEXT_PATH + "/**")
